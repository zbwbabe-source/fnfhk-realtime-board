...
/**
 * Section1 Monthly Trend Payload 타입
 */
...
/**
 * Section1 Monthly Trend 데이터 조회
 * 
 * - 지난 12개월 월별 매출 추이
 * - 채널별 분류: HK 정상/아울렛/온라인, MC 전체
 * - YoY 비교 포함
 */
export async function fetchSection1MonthlyTrend({
  region,
  brand,
  date,
}: {
