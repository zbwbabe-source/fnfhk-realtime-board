...
const toneClass = (
  ...
  if (projectedValue !== null && projectedValue !== undefined && Number.isFinite(projectedValue) && projectedValue >= 100) {
              ...
              {colOrder.map((bucket) => {
                ...
                return (
                  <div
                    ...
                    className={`group relative rounded-xl border p-3 text-center ${toneClass(cell?.progress_pct, cell?.projected_progress_pct, isCompleted)}`}
                  >
